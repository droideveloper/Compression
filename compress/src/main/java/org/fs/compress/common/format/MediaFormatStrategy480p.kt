...
import org.fs.compress.util.C.Companion.VIDEO_BITRATE_480p
import org.fs.compress.util.C.Companion.VIDEO_FRAME_RATE_25
import org.fs.compress.util.C.Companion.VIDEO_I_FRAME_RATE_INTERVAL_480p_360p
import org.fs.compress.util.C.Companion.VIDEO_LARGE_480p
import org.fs.compress.util.C.Companion.VIDEO_SMALL_480p
import org.fs.compress.util.newVideoSize

class MediaFormatStrategy480p(
  videoBitrate: Int,
  videoFrameRate: Int,
  ...
  override fun newVideoSize(videoSize: VideoSize): VideoSize = videoSize.newVideoSize(VIDEO_LARGE_480p, VIDEO_SMALL_480p)

  constructor(): this(VIDEO_BITRATE_480p, VIDEO_FRAME_RATE_25, VIDEO_I_FRAME_RATE_INTERVAL_480p_360p, DEFAULT_AUDIO_BITRATE, DEFAULT_AUDIO_CHANNEL)

  constructor(videoBitrate: Int): this(videoBitrate, VIDEO_FRAME_RATE_25, VIDEO_I_FRAME_RATE_INTERVAL_480p_360p, DEFAULT_AUDIO_BITRATE, DEFAULT_AUDIO_CHANNEL)
