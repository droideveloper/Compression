...
import org.fs.compress.util.C.Companion.VIDEO_BITRATE_1080p
...
import org.fs.compress.util.C.Companion.VIDEO_LARGE_1080p
import org.fs.compress.util.C.Companion.VIDEO_SMALL_1080p
import org.fs.compress.util.newVideoSize

class MediaFormatStrategy1080p(
  videoBitrate: Int,
  videoFrameRate: Int,
  ...
  override fun newVideoSize(videoSize: VideoSize): VideoSize = videoSize.newVideoSize(VIDEO_LARGE_1080p, VIDEO_SMALL_1080p)

  constructor(): this(VIDEO_BITRATE_1080p, VIDEO_FRAME_RATE_30, VIDEO_I_FRAME_RATE_INTERVAL_1080p_720p, DEFAULT_AUDIO_BITRATE, DEFAULT_AUDIO_CHANNEL)
