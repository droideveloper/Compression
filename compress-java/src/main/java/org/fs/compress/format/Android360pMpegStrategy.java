...
import static org.fs.compress.util.Constants.VIDEO_BITRATE_360p;
import static org.fs.compress.util.Constants.VIDEO_FRAME_RATE_24;

final class Android360pMpegStrategy extends BaseMpegFormatStrategy {

  private static final int MAX = 640;
  private static final int MIN = 360;

  Android360pMpegStrategy() {
    super(VIDEO_BITRATE_360p, VIDEO_FRAME_RATE_24);
  }
