...
import static org.fs.compress.util.Constants.VIDEO_BITRATE_720p;
import static org.fs.compress.util.Constants.VIDEO_FRAME_RATE_30;

final class Android720pV8Strategy extends BaseV8FormatStrategy {

  private static final int MAX = 1280;
  private static final int MIN = 720;

  Android720pV8Strategy() {
    super(VIDEO_BITRATE_720p, VIDEO_FRAME_RATE_30);
  }
